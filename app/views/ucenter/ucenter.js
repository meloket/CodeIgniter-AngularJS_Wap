...
.controller('UCenterCtrl', function($rootScope, $scope, $timeout, $state, $ionicHistory, $ionicPopup, Tools, md5, My, UCenter, $location) {
	$scope.base_url = base_url;

	$scope.agenturl = base_url + "/user/regist?uid=" + My.getUserId() + "&username=" + My.getUserName();
	//https://www-pc3333.com/pcmobile/index.html#/reg?pid=62079&type=2
