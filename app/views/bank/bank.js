...
.controller('TransController', function($rootScope, $scope, $stateParams, $ionicHistory, $timeout, $ionicModal, Tools, My, $interval) {
...
.controller('DepositController', function($scope, $log, $state, $ionicHistory, $filter, ENV, Tools, UCenter, BankService) {
...
.controller('OnlinePayController', function($scope, $log, $state, $ionicHistory, $cookies, $filter, ENV, Tools, UCenter, BankService) {
