...
.controller('ListCtrl', function($scope, $window, $log, Lottery, $ionicHistory, $ionicPopover) {
	$log.debug("ListCtrl...");
	...
	$ionicPopover.fromTemplateUrl(base_url + '/app/views/lottery/templates/list-poper.html', {
		scope: $scope
...
.controller('LotteryCtrl',  function($scope, $timeout, $log, $filter, $stateParams, $ionicPopover, $ionicHistory, Lottery, UCenter, $state, Tools, My, $ionicScrollDelegate) {
	...
	$ionicPopover.fromTemplateUrl(base_url + '/app/views/lottery/templates/lottery-poper.html', {
		scope: $scope
	}).then(function(popover) {
        $scope.popover = popover;
	});
	...
	$scope.showRole = function() {
		Tools.modal({
			...
			templateUrl: base_url + "/app/views/lottery/templates/role/role_" + $scope.gameId + ".html",
			css: 'role-poput',
...
.controller('NotcountCtrl', function($scope, $log, $ionicHistory, Tools, Lottery, $state) {
...
.controller('NotcountDetailCtrl', function($scope, $log, $stateParams, $ionicHistory, Tools, Lottery, $state) {
	$scope.gameId = $stateParams.gameId;
...
.controller('SettledCtrl', function($scope, $log, Tools, Lottery, $state, $ionicHistory, UCenter, $filter, $timeout) {
...
.controller('HistoryCtrl', function($scope, $log, $stateParams, $state, $ionicHistory, Tools, Lottery) {
	$scope.queryData = {};
...
.controller('ChangLongCtrl', function($scope, $log, $stateParams, $ionicHistory, Tools, Lottery, $state) {
	$scope.queryData = {};
	$scope.queryData.gameId = parseInt($stateParams.gameId || Lottery.getFirstGameId());
...
.controller('HuodongCtrl', function($scope, $ionicHistory, $log, $stateParams, Tools, Lottery, $state) {
	$scope.queryData = {};
...
.controller('TaskCtrl', function($scope, $log, $ionicHistory, $stateParams, Tools, Lottery, $state) {
	$scope.queryData = {};
	$scope.btval = 1;
...
.controller('LuZhuCtrl', function($scope, $log, $stateParams, $ionicHistory, Tools, Lottery, $state) {
...
.controller('DayRecordCtrl', function($scope, $log, Tools, Lottery, $state, $stateParams, $ionicHistory) {
