...
.controller('LoginCtrl', function($scope, $location, $ionicHistory, $log, Tools, PATH, $cookies, My, md5) {
...
.directive('zlNotice', function(Tools) {
	return {
		...
		link: function(scope, element, attrs) {
			...
			Tools.lazyLoad([base_url + Tools.staticPath() + "data/messages.js?_" + Math.random()], function() {
...
.config(function($stateProvider, $urlRouterProvider, ROUTE_ACCESS) {
	...
	.state('login', {
    	...
    	templateUrl: base_url + '/app/views/login/login.html',
    ...
    .state('reg', {
		...
		cache: false,
    	data : {access : ROUTE_ACCESS.PUBLIC},
    	templateUrl: base_url + '/app/views/login/reg.html',
    	controller: 'RegCtrl'
    })
    ...
    .state('ucenter.index', {
		...
		views: {
    		'ucenter-view': {
    			templateUrl: base_url + '/app/views/ucenter/index.html',
    ...
    .state('ucenter.myinfo', {
    	...
    	views: {
    		'ucenter-view': {
    			templateUrl: base_url + '/app/views/ucenter/myinfo.html',
    			controller: 'UCenterCtrl'
    		}
    	}
    })
    ...
    .state('ucenter.myfpwd', {
    	...
    	views: {
    		'ucenter-view': {
    			templateUrl: base_url + '/app/views/ucenter/mymdfpwd.html',
    			controller: 'UCenterCtrl'
    		}
    	}
    })
    ...
    .state('ucenter.notice', {
    	...
    	views: {
    		'ucenter-view': {
    			templateUrl: base_url + '/app/views/ucenter/notice.html',
    ...
    .state('ucenter.fundpwd', {
    	...
    	views: {
    		'ucenter-view': {
    			templateUrl: base_url + '/app/views/ucenter/fundpwd.html',
    			controller: 'UCenterCtrl'
    		}
    	}
    })
    ...
    .state('ucenter.agentshare', {
    	...
    	views: {
    		'ucenter-view': {
    			templateUrl: base_url + '/app/views/ucenter/agentshare.html',
    			controller: 'UCenterCtrl'
    		}
    	}
    })
    ...
    .state('ucenter.agentrole', {
    	...
    	views: {
    		'ucenter-view': {
    			templateUrl: base_url + '/app/views/ucenter/agentrole.html',
    			controller: 'UCenterCtrl'
    		}
    	}
    });
...
.config(function($stateProvider, $urlRouterProvider, ToolsProvider, ROUTE_ACCESS) {
		...
		resolve : {
			deps : [ "$ocLazyLoad", function($ocLazyLoad) {
				return $ocLazyLoad.load([{
					name : "ionicz.lottery",
					files : [
						base_url + '/app/views/lottery/js/config.js',
					    base_url + '/app/views/lottery/js/controllers.js', 
					    base_url + '/app/views/lottery/js/services.js', 
					    base_url + '/app/views/lottery/js/filters.js', 
					    base_url + '/app/views/lottery/js/directives.js'
					]
				}]);
			} ],
			init: ['$q', 'Tools', function ($q, Tools) {
		        ...
		        Tools.lazyLoad([base_url + Tools.staticPath() + "data/gamedatas.js"], function() {
					Backdrop.hide(500);
					deferred.resolve();
				});
	...
	.state('lottery.list', {
		...
		views: {
			'lottery-view': {
				templateUrl: base_url + '/app/views/lottery/list.html',
				controller: 'ListCtrl'
			}
		}
    })
    ...
    .state('lottery.index', {
		...
		views: {
			'lottery-view': {
				templateUrl: base_url + '/app/views/lottery/lottery.html',
    ...
    .state('lottery.history', {
		...
		views: {
			'lottery-view': {
				templateUrl: base_url + '/app/views/lottery/history.html',
	...
	.state('lottery.huodong', {
		...
		views: {
			'lottery-view': {
				templateUrl: base_url + '/app/views/lottery/huodong.html',
	...
	.state('lottery.task', {
		...
		views: {
			'lottery-view': {
				templateUrl: base_url + '/app/views/lottery/task.html',
				controller: 'TaskCtrl'
			}
		}
	})
    ...
    .state('lottery.notcount', {
		...
		views: {
			'lottery-view': {
				templateUrl: base_url + '/app/views/lottery/notcount.html',
    ...
    .state('lottery.detail', {
		...
		views: {
			'lottery-view': {
				templateUrl: base_url + '/app/views/lottery/notcount_detail.html',
    ...
    .state('lottery.settled', {
		...
		views: {
			'lottery-view': {
				templateUrl: base_url + '/app/views/lottery/settled.html',
    ...
    .state('lottery.changLong', {
    	...
    	views: {
    		'lottery-view': {
    			templateUrl: base_url + '/app/views/lottery/changLong.html',
    ...
    .state('lottery.luZhu', {
    	...
    	views: {
    		'lottery-view': {
    			templateUrl: base_url + '/app/views/lottery/luZhu.html',
    ...
    .state('lottery.week', {
    	...
    	views: {
    		'lottery-view': {
    			templateUrl: base_url + '/app/views/lottery/week.html',
    ...
    .state('lottery.day', {
    	...
    	views: {
    		'lottery-view': {
    			templateUrl: base_url + '/app/views/lottery/day.html',
    ...
    .state('lottery.day_detail', {
    	...
    	views: {
    		'lottery-view': {
    			templateUrl: base_url + '/app/views/lottery/day_detail.html',
...
.config(function($stateProvider, $urlRouterProvider, ToolsProvider, ROUTE_ACCESS) {
	...
	.state('bank', {
		...
		resolve : {
			deps : [ "$ocLazyLoad", function($ocLazyLoad) {
				return $ocLazyLoad.load([{
					name : "ionicz.bank",
					files : [ 
					    base_url + '/app/views/bank/config.js',
					    base_url + '/app/views/bank/bank.js',
					    base_url + ToolsProvider.staticPath() + 'data/paramcfg.js'
					]
				}]);
			} ]
		}
	 ...
	 .state('bank.bank', {
    	...
    	views: {
    		'bank-view': {
    			templateUrl: base_url + '/app/views/bank/bank.html',
	...
	.state('bank.deposit', {
		...
		views: {
			'bank-view': {
				templateUrl: base_url + '/app/views/bank/deposit.html',
    ...
    .state('bank.withdraw', {
		...
		views: {
			'bank-view': {
				templateUrl: base_url + '/app/views/bank/withdraw.html',
    ...
    .state('bank.trans', {
    	...
    	views: {
    		'bank-view': {
    			templateUrl: base_url + '/app/views/bank/trans.html',
    ...
    .state('bank.bankpay', {
    	...
    	views: {
    		'bank-view': {
    			templateUrl: base_url + '/app/views/bank/bankpay.html',
    ...
    .state('bank.onlinepay', {
    	...
    	views: {
    		'bank-view': {
    			templateUrl: base_url + '/app/views/bank/onlinepay.html',
    ...
    .state('bank.cftpay', {
    	...
    	views: {
    		'bank-view': {
    			templateUrl: base_url + '/app/views/bank/cftpay.html',
    			controller:'OfflinePayController'
    		}
    	}
    })
    .state('bank.alipay', {
    	...
    	views: {
    		'bank-view': {
    			templateUrl: base_url + '/app/views/bank/alipay.html',
    			controller:'OfflinePayController'
    		}
    	}
    	...
    	views: {
    		'bank-view': {
    			templateUrl: base_url + '/app/views/bank/wechatpayonline.html',
    			controller:'OnlinePayController'
    		}
    	}
    	...
    	views: {
    		'bank-view': {
    			templateUrl: base_url + '/app/views/bank/wechatpay.html',
    			controller:'OfflinePayController'
    		}
    	}
    	...
    	views: {
    		'bank-view': {
    			templateUrl: base_url + '/app/views/bank/alipayonline.html',
    			controller:'OnlinePayController'
    		}
    	}
    })
