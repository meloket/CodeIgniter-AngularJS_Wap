...
|
*/
$config['base_url'] = 'http://localhost/wap';
...
|
*/
$config['log_threshold'] = 0;	/* aaron-add */
...
$config['debug']['level'] = 5;

$config['db']['prename'] = 'ssc_';

$config['cache']['expire'] = 180;
$config['cache']['dir'] = '_cache_$98sER9@fw!d#s4fef/';

$config['url_modal'] = 2;

$config['member']['sessionTime'] = 1*60;	// 用户有效时长
